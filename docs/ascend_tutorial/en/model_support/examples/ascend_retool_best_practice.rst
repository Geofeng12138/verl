...
The sample model script and the hardware conditions it requires are as follows:
...
*Note: ReTool-SFT is downloaded automatically, and the generated data is saved to the ~/ReTool-SFT/data directory by default.*
...
```bash
bash recipe/retool/run_qwen2_7b_sft_npu.sh # Adapt the paths in the script as needed
```
