...
Ascend provides comprehensive support for using and developing verl. This document provides a complete introduction to using verl on Huawei Ascend NPU chips.
...
- [Ascend Installation Guide](./get_start/install_guidance.rst) - Customize the installation of verl on Ascend NPUs  
...
- [NPU Advanced Features Guide](./feature_support/npu_advance_features.md) - Common NPU-related features/environment variables
...
If you encounter any issues during use, feel free to get help through the following channels:
