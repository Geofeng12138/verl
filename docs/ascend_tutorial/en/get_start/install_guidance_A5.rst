...
============= ================================================= ===================
CANN          Link to be updated after the Q2 CANN version is officially released   CANN software helps developers build and run AI workloads on the Ascend software and hardware platform
